...
toString command =
    case command of
        ...
        EllipticalArc rel (rx, ry) xAxisRotation largeArcFlag sweepFlag (x, y) ->
            let largeArcFlagStr = formatBool largeArcFlag
                sweepFlagStr = formatBool sweepFlag
            in
...
--     [ SvgAttr.width "400"
--     , SvgAttr.height "210"
--     , SvgAttr.viewBox "0 0 400 210"
--     ]
--     [ Svg.path
--           [ SvgAttr.fill "none"
--           , SvgAttr.stroke "red"
--           , SvgPath.d [ SvgPath.MoveTo False (150.0, 0.0)
--                       , SvgPath.LineTo False (75.0, 200.0)
--                       , SvgPath.LineTo False (225.0, 200.0)
--                       , SvgPath.ClosePath ]
--           ]
--           []
--     ]
