...
run g inputs =
    case g of
        ...
        CompareSwap { n, i, j } ->
            let mx = Util.join <| Array.get i inputs
                my = Util.join <| Array.get j inputs
        ...
        Add ->
            let mx = Util.join <| Array.get 0 inputs
                my = Util.join <| Array.get 1 inputs
            in
